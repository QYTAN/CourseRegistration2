...
/*	@Column(name="ASSIGNED_LECTURERID")
	private int assigned_lecturerid;*/
...
/*	public int getAssigned_lecturerid() {
		return assigned_lecturerid;
	}


	public void setAssigned_lecturerid(int assigned_lecturerid) {
		this.assigned_lecturerid = assigned_lecturerid;
	}*/
